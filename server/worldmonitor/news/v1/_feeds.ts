...
export const VARIANT_FEEDS: Record<string, Record<string, ServerFeed[]>> = {
  ...
  india: {
    politics: [
      ...
      { name: 'New Indian Express', url: gnIn('site:newindianexpress.com') },
      { name: 'ABP Live', url: 'https://news.abplive.com/home/feed' },
      { name: 'Zee News', url: gnIn('site:zeenews.india.com') },
      { name: 'News18', url: gnIn('site:news18.com') },
      { name: 'The Quint', url: 'https://prod-qt-images.s3.amazonaws.com/production/thequint/feed.xml' },
      { name: 'Firstpost', url: gnIn('site:firstpost.com') },
      { name: 'DNA India', url: 'https://www.dnaindia.com/feeds/india.xml' },
      { name: 'The Week', url: gnIn('site:theweek.in') },
      { name: 'Outlook India', url: gnIn('site:outlookindia.com') },
      { name: 'Frontline', url: 'https://frontline.thehindu.com/cover-story/feeder/default.rss' },
      { name: 'LiveLaw', url: gnIn('site:livelaw.in') },
      { name: 'The Wire', url: 'https://thewire.in/feed' },
      { name: 'Scroll', url: 'https://scroll.in/feed' },
      { name: 'The Print', url: 'https://theprint.in/feed' },
      { name: 'The News Minute', url: gnIn('site:thenewsminute.com') },
      { name: 'AltNews', url: 'https://www.altnews.in/feed/' },
      { name: 'The Better India', url: 'https://thebetterindia.com/feed/' },
      { name: 'Deccan Herald', url: gnIn('site:deccanherald.com') },
      // Regional outlets
      { name: 'Tribune India', url: gnIn('site:tribuneindia.com') },
      { name: 'Telangana Today', url: 'https://telanganatoday.com/feed' },
      { name: 'Onmanorama', url: gnIn('site:onmanorama.com') },
      { name: 'Siasat', url: 'https://www.siasat.com/feed/' },
      { name: 'Bangalore Mirror', url: gnIn('site:bangaloremirror.indiatimes.com') },
      { name: 'Orissa Post', url: 'https://www.orissapost.com/feed/' },
    ...
    economy: [
      ...
      { name: 'Financial Express', url: gnIn('site:financialexpress.com') },
      { name: 'Hindu Business Line', url: 'https://www.thehindubusinessline.com/?service=rss' },
      { name: 'Fortune India', url: 'https://prod-qt-images.s3.amazonaws.com/production/fortuneindia/feed.xml' },
      { name: 'The Ken', url: gnIn('site:the-ken.com') },
    ...
    technology: [
      ...
      { name: 'Entrackr', url: gnIn('site:entrackr.com') },
      { name: 'StartupTalky', url: 'https://startuptalky.com/rss/' },
      { name: 'TechCircle', url: gnIn('site:techcircle.in') },
      { name: 'Startup India Magazine', url: 'https://startupindiamagazine.com/feed/' },
      { name: 'Know Startup', url: 'https://knowstartup.com/feed/' },
      { name: 'OfficeChai', url: 'https://officechai.com/feed/' },
      { name: 'Indian Startup News', url: gnIn('site:indianstartupnews.com') },
      { name: 'Indian Web2', url: 'https://www.indianweb2.com/feeds/posts/default' },
      { name: 'The Tech Panda', url: 'https://thetechpanda.com/startups-businesses-funding-ma-accelerators/startup-stories-startups/feed/' },
      { name: 'Startup Reporter', url: 'https://startupreporter.in/feed/' },
      { name: 'Forbes India Startups', url: gnIn('site:forbesindia.com startup') },
      { name: 'Startup India Gov', url: gnIn('site:startupindia.gov.in') },
      { name: 'Business Outreach', url: 'https://www.businessoutreach.in/startup/feed/' },
    ],
    government: [
