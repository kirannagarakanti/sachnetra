    ...
    this.ctx.container.innerHTML = `
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ${SITE_VARIANT === 'india'
            ? '<img src="/sachnetra-logo.svg" alt="" width="28" height="28" class="site-footer-icon" style="border-radius:7px" />'
            : '<img src="/favico/favicon-32x32.png" alt="" width="28" height="28" class="site-footer-icon" />'}
          <div class="site-footer-brand-text">
            <span class="site-footer-name">${SITE_VARIANT === 'india' ? 'SACHNETRA' : 'WORLD MONITOR'}</span>
            <span class="site-footer-sub">${SITE_VARIANT === 'india' ? 'See clearly' : 'by Someone.ceo'}</span>
          </div>
        </div>
        <nav>
          ${SITE_VARIANT === 'india' ? `
          <a href="https://sachnetra.com" target="_blank" rel="noopener">Home</a>
          ` : `
          <a href="${this.ctx.isDesktopApp ? 'https://worldmonitor.app/pro' : 'https://www.worldmonitor.app/pro'}" target="_blank" rel="noopener">Pro</a>
          <a href="${this.ctx.isDesktopApp ? 'https://worldmonitor.app/blog/' : 'https://www.worldmonitor.app/blog/'}" target="_blank" rel="noopener">Blog</a>
          <a href="${this.ctx.isDesktopApp ? 'https://worldmonitor.app/docs' : 'https://www.worldmonitor.app/docs'}" target="_blank" rel="noopener">Docs</a>
        ...
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} ${SITE_VARIANT === 'india' ? 'SachNetra' : 'World Monitor'}</span>
      </footer>
    `;
