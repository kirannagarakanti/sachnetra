...
// G7 follow-up: extend research_prices one tier below Smallcap 250 to chase Exp14 N>=20.
const URL = 'https://nsearchives.nseindia.com/content/indices/ind_niftymicrocap250list.csv';
...
async function main() {
  console.log(`Fetching Microcap 250 constituents from ${URL}...`);
  ...
  const outPath = 'shared/nifty-microcap250.json';
